...
cacti_y=LIMIT_LOW
cacti_shift=10
cacti_center_x=cacti_x+img_dinosaur[0].get_width()/2
cacti_center_y=cacti_y+img_dinosaur[0].get_height()/2
cacti_detect_r=max(img_cacti[0].get_width(),img_cacti[0].get_height())/2-15
######################建立視窗######################
